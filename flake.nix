{
  ...
  outputs =
    ...
    let
      ...
      gccrs-contrib-tools = pkgs.callPackage ./nix/packages/gccrs-contrib-tools.nix { };
      ...
      mkGccrsEnv =
        ...
        let
          ...
          gccrs-env-tools = targetPkgs.callPackage ./nix/packages/gccrs-env-tools.nix {
            inherit is32Bit;
          };
        ...
        targetPkgs.mkShell.override { stdenv = targetPkgs.ccacheStdenv; } {
          ...
          shellHook = ''
            ...
            echo "Run 'gccrs-help' to see all available commands"
          '';
